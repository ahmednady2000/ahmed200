...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺ :\na⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺ :\na⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺\n\27[0;33;49m')
...
io.write('\27[1;31m ⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
sudo_users = {SUDO,1778734227,1330033222,1859008079,1910933701}   
...
local UserName = (data.username_ or "So_Tesla")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'تيسلا') 
local DRAGON_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
🚀سعر التنصيب علي سورس تيسلا 
↯سعر التنصيب العادي 20جنيه فقط
🚀للتواصل اتبع الازرار بالاسفل ⇓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙱𝙴𝙱𝙾🚀',url="t.me/Xx_Be_bO_xX"}},
{{text = ' 𝙼𝙰𝙽𝙾🚀',url="t.me/Xx_Ma_nO_xX"}},
{{text = '𝚃𝙾𝙰𝚂𝙺🚀',url="t.me/database7897"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🚀المبرمج بيبو',url="t.me/Xx_Be_bO_xX"}}, 
...
local Text = ' 🚀تم ارسال الملصق من ⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺\n - '..Name
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/tesla_so/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' 🚀 اصدار سورس تيسلا{ 3x☆}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="t.me/database7897"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/beborty/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس تيسلا ادخل وتابع الجديد](t.me/So_Tesla)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺', url="t.me/So_Tesla"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == ' ◁╾╾╾╾⟦𝗧𝗘𝗦𝗟𝗔⟧╾╾╾╾▷' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس تيسلا ادخل وتابع الجديد](t.me/So_Tesla)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/So_Tesla)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/So_Tesla"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 🚀 من أحسن السورسات على التليجرام سورس تيسلا 🚀
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "تيسلا")
...
send(msg.chat_id_,0," 🚀 الـعـضو  : {["..data.first_name_.."](T.ME/So_Tesla)}\n 🚀 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🚀 عذرا  ⇇{["..data.first_name_.."](T.ME/So_Tesla)}\n 🚀 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
╭𖤍━┅⟞⟦[𝐓𝐄𝐒𝐋𝐀](https://t.me/So_Tesla)⟧⟝┉━𖤍╮
                                                                                       
 [𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰](http://t.me/So_Tesla)
                                                                                          
╰𖤍━┅⟞⟦[𝐓𝐄𝐒𝐋𝐀](https://t.me/So_Tesla)⟧⟝┉━𖤍╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ¹',url="t.me/Xx_Be_bO_xX"},{text = 'ᴰᴱᵛᴱᴸᴼᴾᴱᴿ ² ', url="t.me/Xx_Ma_nO_xX"}},
{{text = ' 𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺', url="t.me/So_Tesla"}},
{{text = 'ᯓ اضف البوت لمجموعتك★ ' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰', url="t.me/So_Tesla"}},
{{text = 'اضف البوت تلي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/tesla_so/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'مانو'  then
local Text = [[
مانو مبرمج السورس  للتواصل معه اتبع الزر الاسفل ⬇️🚀.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓌹 ᯓ 𝙼𝙰𝙽𝙾★ 𓌺',url="t.me/Xx_Ma_nO_xX"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/teslaphoto1/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{{text = '🚀رواية "أرض زيكولا"',url="https://t.me/So_Tesla"}},
{{text = '🚀موسوعة الظلام رعب وما شابه ذلك', url="https://t.me/So_Tesla"}},
{{text = '🚀رواية "الشفق الجزء الأول"', url="https://t.me/So_Tesla"}},
{{text = '🚀رواية "المخلوق', url="https://t.me/So_Tesla"}},
{{text = '🚀رواية "بعد النسيان"', url="https://t.me/t.me/So_Tesla"}},
{{text = '🚀كتاب في حضرة الجن', url="https://t.me/https://t.me/t.me/So_Tesla"}},
{{text = '🚀رواية "واختفى كل شئ"', url="https://t.me/t.me/So_Tesla"}},
{{text = '🚀رواية "نيلوفر أسود"', url="https://t.me/t.me/So_Tesla"}},
{{text = '🚀رواية"جثة في الفندق"', url="https://t.me/t.me/So_Tesla"}},
{{text = '🚀رواية "في القطار السريع"', url="https://t.me/t.me/So_Tesla"}},
{{text = '🚀لقاء مع كاتب رعب"', url="https://t.me/t.me/So_Tesla"}},
{{text = '🚀رواية"الإنسان الأخير""', url="https://t.me/t.me/So_Tesla"}},
{{text = '🚀رواية" مقبرة الحيوانات""', url="https://t.me/So_Tesla"}},
{{text = '𝙱𝙴𝙱𝙾🚀',url="t.me/Xx_Be_bO_xX"}},
{{text = ' 𝙼𝙰𝙽𝙾🚀',url="t.me/Xx_Ma_nO_xX"}},
{{text = '𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺', url="t.me/So_Tesla"}},
}
...
local Text = [[
مطورين ومبرمجين سورس تيسلا اتبع الازرار للتواصل معهم ⬇️🚀
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بيبو مبرمج السورس',url="t.me/Xx_Be_bO_xX"}},
...
if text == "مانو" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(28,56); 
local Text ='مانو مبرمج السورس  للتواصل معه اتبع الزر الاسفل ⬇️🚀.' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' 𝙼𝙰𝙽𝙾🚀',url="t.me/Xx_Ma_nO_xX"}},
}  
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/manotesla/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "بيبو" or text == "المبرمج بيبو" or text == "باهر" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(2,22); 
local Text = "بيبو مبرمج السورس للتواصل معه اتبع الزر الاسفل ⬇️🚀"
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙱𝙴𝙱𝙾🚀',url="t.me/Xx_Be_bO_xX"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/bebo789/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺' then
local Text = [[ 
 🚀من أحسن السورسات على التليجرام سورس تيسلا 🚀
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺](http://t.me/So_Tesla)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺', url="t.me/So_Tesla"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/database7897)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺', url="t.me/database7897"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/tesla_so/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب تيسلا' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 🚀 اهلا في قائمه الالعاب المتطوره سورس تيسلا 🚀 
...
if tonumber(result.sender_user_id_) == tonumber(1910933701) then  
...
function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'So_Tesla')..')'
...
usertext = '\n 🚀 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'So_Tesla')..')'
status  = '\n 🚀 تم حظرو عام من الجروبات '
texts = usertext..status
...
if Get_info then
local TextS = "\n 🚀 اهلا بك في متجر ملفات تيسلا\n 🚀 ملفات السورس ⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺\n 🚀 علامة تعني { ✔️ } ملف مفعل\n 🚀 علامة تعني { ✖ } ملف معطل\n 🚀 قناة سورس تيسلا⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺\n".." 🚀 [اضغط هنا لدخول](t.me/So_Tesla) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 🚀 عذرا الملف لايدعم سورس تيسلا\n") 
end
return false
end
...
if text == ("مسح قائمه تيسلا") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🚀 تم مسح قائمه تيسلا')
return false
end

if text == 'قائمه تيسلا' and Sudo(msg) then
...
if text == ("رفع تيسلا") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع تيسلا@(.*)$") and Sudo(msg) then
local username = text:match("^رفع تيسلا@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع تيسلا(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع تيسلا(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل تيسلا") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل تيسلا@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل تيسلا@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل تيسلا(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل تيسلا(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = "\n 🚀 قائمه زوجات الجروب \n 🚀═───═❲[𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺](t.me/So_Tesla)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
' }\nء⧬━┅┅┄⟞❲[᪣𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺᪣](t.me/So_Tesla)❳⟝┄┉┉━⧬'..
'\n 🚀  علامة ال {✓} تعني مفعل'..
'\n 🚀  علامة ال {✘} تعني معطل'..
'\nء⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺'..
'\n'..' 🚀  امر صيح  ⇇{ '..kickme..
...
' }\n'..' 🚀  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 🚀  الرفع  ⇇{ '..setadd..
' }\n'..' 🚀  الحظر  ⇇{ '..banm..' }\n\n 🚀═───═❲[𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺](t.me/So_Tesla)❳═───═ 🚀\n 🚀 قناة سورس تيسلا⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺\n [ ❲[𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺](t.me/So_Tesla)❳](t.me/So_Tesla) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺ٴ\n 🚀 ❲[𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺](t.me/So_Tesla)❳ 🚀 ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيسلا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تيسلا')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس تيسلا🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي ??',
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/rdodotesla/15&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'احا' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃??𝚂𝙻𝙰 ★ 𓌺', url="t.me/So_Tesla"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/rdodotesla/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'كسمك' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/rdodotesla/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '😂😂' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/rdodotesla/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'بمت' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/rdodotesla/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'اتفو' or text == 'تفو' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/rdodotesla/16&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'تعالي' or text == 'تعا' or text == 'متيجي' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/rdodotesla/17&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'هات' or text == 'هاتي' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/rdodotesla/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/rdodotesla/19&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'اه' or text == 'ايوه' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/rdodotesla/20&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'تسلم' or text == 'محح' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/rdodotesla/23&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'جيت' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/rdodotesla/25&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '😒😒' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓌹 ᯓ??𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺', url="t.me/So_Tesla"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/rdodotesla/26&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/rdodotesla/27&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
end --الكود حصري سورس تيسلايعني لو بكتهن راح اعرفك انت الاخذتهن
...
if text == "ال.ساعه" then
local ramsesj20 = "\n الساعه الان : "..os.date("%I:%M%p")
send(msg.chat_id_, msg.id_,ramsesj20)
end

if text == "التا.ريخ" then
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيسلا').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مبرمج السورس يروحي😊](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطور السورس يجامد 😍💚](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مالك السورس يجامد 😍💚](t.me/So_Tesla)')
return false
end
if text == 'انا مين' and DevSoFi(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🚀♥️](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/So_Tesla)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🚀](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🚀💕](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/So_Tesla)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..🚀💕](t.me/So_Tesla)')
return false
end
end
end
...
keyboard.inline_keyboard = {
{
{text = '𝗺𝘆 𝗰𝗵𝗮𝗻𝗻𝗲𝗹𝘀 ⧫', callback_data="/help92"},{text = '𝗱𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿𝘀 ⚚', callback_data="/help93"},
},
{
{text = '𓌹 ᯓ المطور ★ 𓌺', url="http://t.me/"..sudos.UserName},
},
...
[🚀ألعاب سورس تيسلا الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺](t.me/So_Tesla)
]]
keyboard = {} 
...
if Text == '/help92' then
local Teext =[[
 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺', url="t.me/So_Tesla"}},  
{{text = ' 𓌹 عند الساعة ٤:٠٠ فجراً . 𓌺', url="t.me/UU_MaN_UU"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/help94"}},
}
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺
 اختر الامر الذي تريدها .↑⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺
ده من الازرار بلاسفل . ⩹━━━⊶⟦𝐓𝐄𝐒𝐋𝐀⟧⊷━━━⩺
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺](t.me/So_Tesla)❳ 
]]
keyboard = {} 
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑《𝚃𝙴𝚂𝙻𝙰》
🕹 اختر العبه الذي تريدفي الاسفل ..↑《𝚃𝙴𝚂𝙻𝙰》
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[𓌹 ᯓ𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝚂𝙻𝙰 ★ 𓌺](t.me/So_Tesla)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تيسلا')
